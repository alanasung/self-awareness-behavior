...
This note situates **Behavioral Tests for Self-Knowledge Claims** against the mentor-linked literature for
[Behavioral Tests for Self-Knowledge Claims](https://github.com/alanasung/self-awareness-behavior).

## Positioning

Run behavior-based probes of what models can report about their own limits and processes.

The design hypothesis is: Run behavior-based probes of what models can report about their own limits and processes.
