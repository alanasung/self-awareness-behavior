...
from selfaware.configs.loader import register_schema
...
def _load_stage_registry(package: str = "selfaware") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in selfaware.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from selfaware.configs.loader import config_to_dict, save_resolved_config
    from selfaware.models.device import get_device
    from selfaware.utils.logging import configure_logging
    from selfaware.utils.reproducibility import set_seed
    from selfaware.utils.run_manifest import create_run_dir, save_run_metadata
