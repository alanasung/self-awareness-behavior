...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from selfaware.configs.loader import save_resolved_config
    from selfaware.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from selfaware.configs.loader import available_presets
